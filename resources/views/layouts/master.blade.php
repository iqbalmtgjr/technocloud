...
<head>
  ...
  <title>Jasa Pembuatan Website - Techno Cloud</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href={{asset("assets/img/technocloud/ico_web3.png")}} rel="icon">
...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto" ><a href="index.html"><img style="width: 180px; height:150px" src="{{asset("assets/img/technocloud/WEB.png")}}" alt=""></a></h1>
      ...
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="d-flex justify-content-center justify-content-lg-start">
            <a href="https://wa.me/628996979079" class="btn-get-started scrollto">Hubungi Kami <i class="bi bi-telephone-fill"></i></a>
      ...
      <div class="container" data-aos="zoom-in">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 cta-btn-container text-center">
            <a class="cta-btn align-middle" href="#">Hubungi Kami <i class="bi bi-telephone"></i></a>
          </div>
        </div>
